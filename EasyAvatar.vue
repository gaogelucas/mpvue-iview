...
<div class="vue-avatar--wrapper" :style="style">
    <div v-if="!isImage">{{ userInitial }}</div>
    <img v-if="isImage" :src="src" :style="imgAvatarStyle">
</div>
</template>

<script>
import { classes, styles } from "@/utils/css.js";
  ...
  computed: {
    ...
    style() {
      ...
      const initialBackgroundAndFontStyle = {
        ...
        font:
          Math.floor(this.size / 2.5) + "px/100px Helvetica, Arial, sans-serif",
